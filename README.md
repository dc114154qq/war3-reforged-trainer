...
从 GitHub Release 下载 `War3ReforgedTrainer-v1.0.0.exe`，直接双击运行即可。这是 PyInstaller 打包的单文件 GUI 程序，不会额外弹出终端窗口，也不需要安装 Python。
...
- 大象功能与快捷键：提供地图、单位、英雄、物品、技能、科技、增益/减益及全屏效果等功能，并配套 45 个可独立启用的全局快捷键。
