...
def main() -> None:
    ...
    matrix = [
        ...
        {"feature": "inventory read", "status": "validated", "evidence": "3.0 slot-array + item wrapper validation"},
        {"feature": "inventory charge write", "status": "code-routed; live write pending", "evidence": "set_selected_inventory_charges"},
        {"feature": "existing ability enumeration", "status": "validated read-only", "evidence": "ability-instances-live.json"},
